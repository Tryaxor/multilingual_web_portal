...
<body>
    ...
    <main>
        ...
        <article>
            <header>
                <h2>
                    <?getTranslation("title2")?>
                </h2>
                <p></p>
            </header>
            <div class="article_main">
                <h3>
                    <?getTranslation("title2_1")?>
                </h3>

                <p>
                    <?getTranslation("txt2_1");?>
                </p>

                <h3>
                    <?getTranslation("title2_2")?>
                </h3>

                <p>
                    <?getTranslation("txt2_2");?>
                </p>
            </div>
            <footer>
                <p>
                    <?getTranslation("footer2");?>
                </p>
            </footer>
        </article>
